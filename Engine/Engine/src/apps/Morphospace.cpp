...
Morphospace::Morphospace(float scaleLength): scaleLength(scaleLength) {
	...
	modulePrototypeFunctions[0][0] = [=](BranchModule* module) -> BranchModule* {
		BranchNode* child = module->root->createChild({ 0.0f, 18.0f, 0.0f }, scaleLength);
		{
			BranchNode* childA = child->createChild({ 9.0f, 9.0f, -4.5f }, scaleLength);
			{
				...
				{
					BranchNode* childA1a = childA1->createChild({ 2.0f, 2.0f, -1.0f }, scaleLength);

					BranchNode* childA1b = childA1->createChild({ 4.0f, 1.0f, 0.0f }, scaleLength);
					{
						BranchNode* childA1b1 = childA1b->createChild({ 2.0f, -0.5f, 1.0f }, scaleLength);
						BranchNode* childA1b2 = childA1b->createChild({ 2.0f, 3.0f, -1.0f }, scaleLength);
					}
				}

				BranchNode* childA2 = childA->createChild({ 2.0f, 7.0f, -3.0f }, scaleLength);
				{
					BranchNode* childA2a = childA2->createChild({ 0.5f, 4.0f, -2.0f }, scaleLength);
				}
			...
			BranchNode* childB = child->createChild({ 0.0f, 12.0f, 0.0f }, scaleLength);
			{
				BranchNode* childB1 = childB->createChild({ 6.0f, 12.0f, 2.0f }, scaleLength);
				{
					BranchNode* childB1a = childB1->createChild({ 2.0f, 3.5f,0.0f }, scaleLength);
					{
						...
						{
							BranchNode* childB1a1a = childB1a1->createChild({ 1.5f, 3.0f,0.0f }, scaleLength);
							BranchNode* childB1a1b = childB1a1->createChild({ -1.0f, 3.0f,0.0f }, scaleLength);
						}
					}

					BranchNode* childB1b = childB1->createChild({ -0.50f, 3.5f,0.0f }, scaleLength);
					{
						BranchNode* childB1b1 = childB1b->createChild({ 0.0f, 4.0f,0.0f }, scaleLength);
					}
				}

				BranchNode* childB2 = childB->createChild({ -4.0f, 6.0f, -2.0f }, scaleLength);
				{
					BranchNode* childB2a = childB2->createChild({ -3.0f, 6.0f, -2.0f }, scaleLength);

					BranchNode* childB2b = childB2->createChild({ -1.5f, 1.0f,1.0f }, scaleLength);
					{
						BranchNode* childB21 = childB2b->createChild({ 0.5f, 2.0f,0.5f }, scaleLength);
						BranchNode* childB22 = childB2b->createChild({ -2.0f, -1.0f, 1.0f }, scaleLength);
					}
				}
			}
			...
			BranchNode* childC = child->createChild({ -9.0f, 9.0f, -5.0f }, scaleLength);
			{
				...
				{
					BranchNode* childC1a = childC1->createChild({ 0.0f, 3.0f,0.0f }, scaleLength);
					BranchNode* childC1b = childC1->createChild({ -2.0f, 3.5f,0.0f }, scaleLength);
				}

				BranchNode* childC2 = childC->createChild({ -6.0f, 1.0f,0.0f }, scaleLength);
				{
					BranchNode* childC2a = childC2->createChild({ -5.0f, 2.0f,0.0f }, scaleLength);
					BranchNode* childC2b = childC2->createChild({ -2.0f, -1.0f,0.0f }, scaleLength);
				}
			}
		}
		return module;
	...
	modulePrototypeFunctions[2][2] = [=](BranchModule* module) -> BranchModule* {
		BranchNode* child = module->root->createChild({ 0.0f, 12.0f, 0.0f }, scaleLength);
		{
			...
			{
				BranchNode* childA1 = childA->createChild({ 3.0f, 1.0f, 1.0f }, scaleLength);
				module->tips.push_back(childA1);
				BranchNode* childA2 = childA->createChild({ 4.0f, 5.0f, -2.0f }, scaleLength);
				module->tips.push_back(childA2);
				BranchNode* childA3 = childA->createChild({ 1.5f, 2.5f, -1.5f }, scaleLength);
				module->tips.push_back(childA3);
			}

			BranchNode* childB = child->createChild({ 0.0f, 7.0f, 0.0f }, scaleLength);
			{
				BranchNode* childB1 = childB->createChild({ 5.0f, 9.5f, 0.5f }, scaleLength);
				module->tips.push_back(childB1);
				BranchNode* childB2 = childB->createChild({ 0.0f, 15.0f, 0.0f }, scaleLength);
				{
					BranchNode* childB2a = childB2->createChild({ 2.0f, 4.5f, 1.5f }, scaleLength);
					module->tips.push_back(childB2a);
					BranchNode* childB2b = childB2->createChild({ 0.0f, 6.5f, 0.0f }, scaleLength);
					{
						BranchNode* childB2b1 = childB2b->createChild({ 3.5f, 6.0f, -0.5f }, scaleLength);
						module->tips.push_back(childB2b1);
						BranchNode* childB2b2 = childB2b->createChild({ 0.0f, 6.5f, 0.0f }, scaleLength);
						module->tips.push_back(childB2b2);
						BranchNode* childB2b3 = childB2b->createChild({ -3.0f, 6.0f, 0.5f }, scaleLength);
						module->tips.push_back(childB2b3);
					}
					BranchNode* childB2c = childB2->createChild({ -2.5f, 6.0f, -2.0f }, scaleLength);
					module->tips.push_back(childB2c);
				}

				BranchNode* childB3 = childB->createChild({ -3.0f, 4.5f, 1.5f }, scaleLength);
				{
					BranchNode* childB3a = childB3->createChild({ -1.5f, 3.0f, -0.5f }, scaleLength);
					module->tips.push_back(childB3a);
					BranchNode* childB3b = childB3->createChild({ -2.0f, 1.5f, 1.0f }, scaleLength);
					module->tips.push_back(childB3b);
					BranchNode* childB3c = childB3->createChild({ -1.0f, -0.5f, 0.2f }, scaleLength);
			...
			{
				BranchNode* childC1 = childC->createChild({ -0.2f, 3.5f, -1.0f }, scaleLength);
				module->tips.push_back(childC1);
				BranchNode* childC2 = childC->createChild({ -2.5f, 3.0f, -1.5f }, scaleLength);
				{
					BranchNode* childC2a = childC2->createChild({ -1.0f, 3.0f, -0.5f }, scaleLength);
					module->tips.push_back(childC2a);
					BranchNode* childC2b = childC2->createChild({ -2.0f, 2.0f, 0.0f }, scaleLength);
					module->tips.push_back(childC2b);
					BranchNode* childC2c = childC2->createChild({ -1.0f, 0.1f, 0.5f }, scaleLength);
					module->tips.push_back(childC2c);
				}
				BranchNode* childC3 = childC->createChild({ -3.0f, 0.5f, 1.5f }, scaleLength);
